...
public class MacosPasswordField extends PasswordField implements MacosControlWithAccentColor {
    ...
    // ******************** Constructors **************************************
    public MacosPasswordField() {
        super();
        init();
    }
    public MacosPasswordField(final String text) {
        super();
        setText(text);
        init();
    }
    ...
    @Override public final BooleanProperty darkProperty() {
        if (null == dark) {
            dark = new BooleanPropertyBase() {
                ...
                @Override public Object getBean() { return MacosPasswordField.this; }
